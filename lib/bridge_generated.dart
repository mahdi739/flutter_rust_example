...
class RustImpl implements Rust {
  ...
  Future<List<String>> doHeavyWork({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_do_heavy_work(port_),
      parseSuccessData: _wire2api_StringList,
      constMeta: kDoHeavyWorkConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  void wire_do_heavy_work(
    int port_,
  ) {
    return _wire_do_heavy_work(
      port_,
    );
  }

  late final _wire_do_heavy_workPtr =
